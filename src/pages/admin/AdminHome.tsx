      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="forest-card">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-bold text-forest-glow">
              Shop Description
            </h2>
            {!editing && (
              <button
        ...
        {/* YouTube URL */}
        <div className="forest-card">
          <h2 className="text-xl font-bold text-forest-glow mb-6">
            Featured Video
          </h2>
            ...
            <div>
              {shop?.youtubeUrl ? (
                <div className="space-y-3">
                  <p className="text-forest-text break-all">
                    {shop.youtubeUrl}
                  </p>
