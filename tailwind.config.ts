  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(var(--forest-glow) / 0.3)" },
          "50%": { boxShadow: "0 0 40px hsl(var(--forest-glow) / 0.6)" },
        },
        "fade-in-up": {
      ...
      animation: {
        ...
        "snake-slither": "snake-slither 4s ease-in-out infinite",
